...
| config.collabora.selectors.namespace | string | `""` | Namespace in which collabora is deployed; defaults to this helm charts namespace. |
...
| config.diagrams.selectors.namespace | string | `""` | Namespace in which diagrams/cryptpad is deployed; defaults to this helm charts namespace. |
| config.diagrams.selectors.pods | string | `"cryptpad-.+"` | Regex which identifies pods belonging to diagrams/cryptpad by name |
| config.diagrams.selectors.pvcs | string | `""` | Regex which identifies persistent volume claims belonging to diagrams/cryptpad by name |
...
| config.jitsi.selectors.namespace | string | `""` | Namespace in which jitsi is deployed; defaults to this helm charts namespace. |
...
| config.matrix.selectors.namespace | string | `""` | Namespace in which matrix/synapse is deployed; defaults to this helm charts namespace. |
...
| config.nextcloud.selectors.namespace | string | `""` | Namespace in which nextcloud is deployed; defaults to this helm charts namespace. |
...
| config.nubus.selectors.namespace | string | `""` | Namespace in which nubus is deployed; defaults to this helm charts namespace. |
...
| config.openProject.selectors.namespace | string | `""` | Namespace in which OpenProject is deployed; defaults to this helm charts namespace. |
...
| config.xwiki.selectors.namespace | string | `""` | Namespace in which xwiki is deployed; defaults to this helm charts namespace. |
